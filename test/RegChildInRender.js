var RegChildInRender = function($,Mustache,Nimbly,PersonData,ListItemComp) {
	...
	class componentClass extends Nimbly {
		...
		constructor(data, options) {
			super("RegChildInRender", defaults, data || {}, options || {});
		};
...
if (typeof module === "undefined") {
	window["RegChildInRender"] = RegChildInRender($,Mustache,Nimbly,PersonData,ListItemComp);
} else {
	module.exports = function($,Mustache,Nimbly,PersonData,ListItemComp) {
		return RegChildInRender($,Mustache,Nimbly,PersonData,ListItemComp);
	};
}
